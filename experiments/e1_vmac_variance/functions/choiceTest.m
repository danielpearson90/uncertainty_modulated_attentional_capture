...
for block = 1 : numChoiceBlocks
    ...
    for trial = 1 : numTestTypes
        ...
        trialData = [block, trial, trialCounter, testType(trial), testDistract(testDistractType(testType(trial)), :), stimOrder(testType(trial)), targetLoc, distractLoc, choiceMade];
        ...
        meanReward = 50;    % On average win 50 points regardless of distractor type
