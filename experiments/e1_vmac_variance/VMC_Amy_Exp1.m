...
if exist('choicePointsWon', 'var')
    totalPoints = totalPoints + choicePointsWon;        % Don't bother recording the total with choice points added, as they are the same for everyone
end
