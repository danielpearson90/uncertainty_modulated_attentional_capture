...
data_files <- fs::dir_ls(here("data", "e2", "raw_data", "BehavData"),
  glob = "*.csv"
)
choice_files <- fs::dir_ls(here("data", "e2", "raw_data", "ChoiceData"),
  glob = "*.csv"
)
estimation_files <- fs::dir_ls(here("data", "e2", "raw_data", "EstimationData"),
  glob = "*.csv"
)
